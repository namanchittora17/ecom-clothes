...
const Product7 = () => {
  ...
  const product = {
    id: 7,
    name: "Parada - Saffiano Leather Travel Bag",
    price: 16500,
    image:
      "https://www.prada.com/content/dam/pradabkg_products/2/2VC/2VC018/9Z2F0002/2VC018_9Z2_F0002_V_OOO_SLF.jpg/_jcr_content/renditions/cq5dam.web.hebebed.2400.2400.jpg",
  };
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">
            This elegant duffle bag in Saffiano leather with all-around zipper
            and nylon shoulder strap has rigorous design. The leather name tag
            and metal lock engraved with the lettering logo decorate this
            accessory.
          </p>
