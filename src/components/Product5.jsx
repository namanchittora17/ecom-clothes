...
const Product5 = () => {
  ...
  const product = {
    ...
    price: 899,
    image:
      "https://image.hm.com/assets/hm/98/22/98229fb844ba795513d06369c1fd34477301bdab.jpg?imwidth=1260",
  };
    ...
    <main className="px-8 py-16 max-w-5xl mx-auto">
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">Classic tie in woven fabric.</p>
