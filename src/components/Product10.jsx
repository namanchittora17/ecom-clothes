...
function Product10() {
  ...
  const product = {
    ...
    price: 4799,
    image:
      "https://image.hm.com/assets/hm/70/10/7010dd67dd0e9c97ac6489437eee257c5c418106.jpg?imwidth=1260",
  };
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">
            Ankle-length trousers in soft cotton twill featuring an elasticated
            waist, zip fly with a button, diagonal side pockets, jetted back
            pockets with a button and legs with creases. Slim fit that hugs the
            contours of your body, creating a fitted silhouette.
          </p>
